...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # as classifier label
       modal_image = images_dir + key
       model_label = classifier(modal_image, model)
       print(modal_lable)
       ...
       # set labels to lowercase (lower) and stripping off whitespace(strip)
        ...
        low_pet_image = modal_lable.lower()
       ...
       if truth in model_label:
           results_dic.extend(modal_lable, 1)
       ...
       # the extend function 
           ...
           results_dic.extend("NOT a match", 0)
